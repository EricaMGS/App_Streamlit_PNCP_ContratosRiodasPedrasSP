...
if st.sidebar.button(
    ...
    if tipo_consulta == "Contratos":
        ...
        # Filtros para evitar trazer registros do Brasil inteiro
        params["uf"] = UF
    ...
    try:
        ...
        if registros:
            ...
            # Mantemos uma filtragem complementar para segurança.
            # Não dependemos exclusivamente dela para localizar
            # Rio das Pedras.
